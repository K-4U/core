...
STEAM_ICON_URL = "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/apps/%d/%s.jpg"
...
class SteamSensor(Entity):
    ...
    def update(self):
        ...
        try:
            ...
            if not self._owned_games:
                self._owned_games = self._steamod.api.interface('IPlayerService').GetOwnedGames(steamid=self._account, include_appinfo=1)
    ...
    def device_state_attributes(self):
        ...
        if self._extra_game_info is not None and self._game_id is not None:
            attr["game_icon"] = STEAM_ICON_URL%(self._game_id, self._extra_game_info['img_icon_url'])
